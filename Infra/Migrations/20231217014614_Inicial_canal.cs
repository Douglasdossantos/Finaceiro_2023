    ...
    public partial class Inicial_canal : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsuariSistemaFinanceiro", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UsuariSistemaFinanceiro_SistemaFinanceiro_IdSistema",
                        column: x => x.IdSistema,
                        principalTable: "SistemaFinanceiro",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DataVenciment = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UsuariSistemaFinanceiro_IdSistema",
